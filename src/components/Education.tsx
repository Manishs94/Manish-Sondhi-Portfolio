    ...
    <section id="education" className="py-24 bg-gray-50 dark:bg-gray-900">
      <div className="section-container">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="section-heading">Learning & Growth</h2>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            ...
            {education.map((edu, index) => (
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in"
          ...
          <div>
            ...
            {certifications.map((cert, index) => (
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in"
                style={{ animationDelay: `${0.1 * (education.length + index)}s` }}
              >
                  ...
                  {cert.image && (
                    <div className="flex-shrink-0">
                      <img 
                        ...
                        className="w-full lg:w-64 h-48 object-contain rounded-lg border border-gray-200 dark:border-gray-700"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col md:flex-row md:items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        {cert.credentialId && (
                          <div className="text-sm text-portfolio-text-light dark:text-gray-400 mb-4">
                      ...
                      {cert.link && (
                        <div className="mt-4 md:mt-0 md:ml-6">
                          <a
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-portfolio-accent text-white rounded-lg hover:bg-opacity-90 transition-colors duration-300"
                          >
