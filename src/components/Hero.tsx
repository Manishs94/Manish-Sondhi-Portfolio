      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-portfolio-text-dark mb-6 animate-fade-in opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
              Creating <span className="text-portfolio-accent">delightful experiences</span> that users love
            </h1>
            <p className="text-lg text-portfolio-text-light mb-8 max-w-lg animate-fade-in opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            ...
            <div className="flex flex-wrap gap-4 mb-8 animate-fade-in opacity-0" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            ...
            <div className="flex items-center gap-6 animate-fade-in opacity-0" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
