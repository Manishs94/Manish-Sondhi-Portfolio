...
const skillsData: Skill[] = [
  ...
  { name: 'Visual Design', level: 90, category: 'design' },
  ...
  { name: 'A/B Testing', level: 82, category: 'research' },
  
  // Tools
  { name: 'Figma', level: 95, category: 'tools' },
  { name: 'Adobe XD', level: 88, category: 'tools' },
  { name: 'Protopie', level: 85, category: 'tools' },
  { name: 'Principle', level: 80, category: 'tools' },
  ...
  { name: 'Responsive Design', level: 90, category: 'development' }
];
